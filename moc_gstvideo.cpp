...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_gstvideo_t, stringdata0) + ofs \
...
QT_MOC_LITERAL(12, 124, 30), // "on_videoList_currentRowChanged"
QT_MOC_LITERAL(13, 155, 10), // "currentRow"
QT_MOC_LITERAL(14, 166, 30) // "on_audioList_currentRowChanged"

    },
    "gstvideo\0start\0\0stop\0contrast\0brightness\0"
    "hue\0saturation\0on_comboBox_currentIndexChanged\0"
    "index\0avolume\0on_pushButton_clicked\0"
    "on_videoList_currentRowChanged\0"
    "currentRow\0on_audioList_currentRowChanged"
};
...
void gstvideo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 9: _t->on_videoList_currentRowChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 10: _t->on_audioList_currentRowChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
void *gstvideo::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_gstvideo.stringdata0))
