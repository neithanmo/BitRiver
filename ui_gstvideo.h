...
public:
    ...
    void setupUi(QWidget *gstvideo)
    {
        ...
        bplay->setGeometry(QRect(350, 510, 81, 31));
        bstop = new QToolButton(gstvideo);
        bstop->setObjectName(QStringLiteral("bstop"));
        bstop->setGeometry(QRect(350, 570, 81, 31));
        ...
        slider5->setGeometry(QRect(50, 640, 160, 27));
