...
INCPATH       = -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64 -I. -I/usr/local/include/gstreamer-1.0 -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I. -I.
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/gstvideo1.0.0/ && $(COPY_FILE) --parents gstvideo.h gstaudio.h .tmp/gstvideo1.0.0/ && $(COPY_FILE) --parents main.cpp gstvideo.cpp gstaudio.cpp .tmp/gstvideo1.0.0/ && $(COPY_FILE) --parents gstvideo.ui .tmp/gstvideo1.0.0/ && (cd `dirname .tmp/gstvideo1.0.0` && $(TAR) gstvideo1.0.0.tar gstvideo1.0.0 && $(COMPRESS) gstvideo1.0.0.tar) && $(MOVE) `dirname .tmp/gstvideo1.0.0`/gstvideo1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/gstvideo1.0.0
...
compiler_rcc_clean:
compiler_moc_header_make_all: moc_gstvideo.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_gstvideo.cpp
...
compiler_uic_make_all: ui_gstvideo.h
compiler_uic_clean:
	-$(DEL_FILE) ui_gstvideo.h
...
gstaudio.o: gstaudio.cpp gstaudio.h \
		/usr/include/qt5/QtWidgets/QWidget \
		/usr/include/qt5/QtWidgets/qwidget.h \
		/usr/include/qt5/QtGui/qwindowdefs.h \
		/usr/include/qt5/QtCore/qglobal.h \
		...
		/usr/include/qt5/QtWidgets/qabstractslider.h \
		/usr/local/include/gstreamer-1.0/gst/audio/streamvolume.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o gstaudio.o gstaudio.cpp
