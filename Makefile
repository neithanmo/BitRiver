...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/gstvideo1.0.0/ && $(COPY_FILE) --parents gstvideo.h ui_gstvideo.h .tmp/gstvideo1.0.0/ && $(COPY_FILE) --parents gstvideo.cpp main.cpp .tmp/gstvideo1.0.0/ && (cd `dirname .tmp/gstvideo1.0.0` && $(TAR) gstvideo1.0.0.tar gstvideo1.0.0 && $(COMPRESS) gstvideo1.0.0.tar) && $(MOVE) `dirname .tmp/gstvideo1.0.0`/gstvideo1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/gstvideo1.0.0
