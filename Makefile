...
DIST          = /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		gstvideo.pro gstvideo.h \
		ui_gstvideo.h \
		inputbox.h gstvideo.cpp \
		main.cpp \
		inputbox.cpp
...
distdir: FORCE
	...
	$(COPY_FILE) --parents gstvideo.h ui_gstvideo.h inputbox.h $(DISTDIR)/
	$(COPY_FILE) --parents gstvideo.cpp main.cpp inputbox.cpp $(DISTDIR)/
